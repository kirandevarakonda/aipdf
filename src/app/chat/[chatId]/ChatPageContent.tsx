...
"use client";
import Link from "next/link";
import { FileText, Home, MessageSquare, ChevronsLeft, ChevronsRight, Menu } from "lucide-react";
import { Button } from "@/components/ui/button";
    ...
    return (
        <div className="h-full flex flex-col">
            ...
            <div className="flex-1 flex overflow-hidden bg-gray-50">
                ...
                <div className="hidden md:flex w-12 border-r bg-white flex-col items-center py-4 gap-4">
                    <Button
                        variant="ghost"
                        size="icon"
                        onClick={() => setSidebarOpen(!sidebarOpen)}
                ...
                {/* Sidebar */}
                {sidebarOpen && (
                    <div className="w-full md:w-80 border-r bg-white overflow-hidden flex flex-col absolute md:relative z-10 h-full">
                        <div className="p-4 border-b">
                            <h2 className="text-lg font-semibold flex items-center gap-2">
                                <MessageSquare className="h-5 w-5 text-primary" />
                                Chat History
