    ...
    return (
        ...
        <div className="mt-2 p-1">
          <div className="flex flex-col justify-center items-center">
            ...
            <span className="font-bold text-4xl pt-4">Find the <span className="text-purple-600">Perfect plan</span></span>
            <span className="font-light text-gray-500 pt-4">Simple, transparent pricing that grows with you. Free to start and cheap to scale.</span>
          </div>
      </div>
        <MainIntro5/>
        <MainIntro9/>
