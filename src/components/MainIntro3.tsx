...
//           {/* File Cards Section */}
//           <div>
//             <div className="flex justify-center gap-4 mt-2 mb-4 p-7">
...
const MainIntro3 = () => {
  return (
    <>
      <div id="usecases" className="flex justify-center mt-16 px-4">
        <div className="bg-gradient-to-l from-[rgba(3,121,255,0.1608)] via-[rgba(183,75,221,0.1608)] to-[rgba(255,128,95,0.1608)] w-full max-w-5xl border-2 rounded-3xl p-6">
          <div className="flex flex-col gap-2 items-center justify-center mt-6 mb-4 text-center">
            <div>
              <span className="text-customPurple text-lg font-medium">✨ GET STARTED</span>
            </div>
            <div>
              <span className="text-3xl md:text-4xl font-bold">Built for any use case</span>
            </div>
            <div>
              <span className="text-base text-gray-500">Click on each option to try it out 👇</span>
            </div>
          ...
          {/* File Cards Section */}
          <div className="flex flex-wrap justify-center gap-4 mt-2 mb-4 p-4">
            {[
              ...
              <div
                key={index}
                className="bg-white border border-gray-50 rounded-2xl w-full sm:w-[220px] flex justify-center pt-2 pb-2 shadow-xl shadow-gray-300 hover:shadow-2xl hover:scale-105 transition-all duration-300 ease-in-out"
              >
                <button className="font-semibold text-sm">{file}</button>
              </div>
            ))}
          </div>
        </div>
